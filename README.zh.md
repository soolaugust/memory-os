...
[![Tests](https://img.shields.io/badge/tests-38%20passing-brightgreen)](#测试)
[![License](https://img.shields.io/badge/license-MIT-green)](LICENSE)
[![Iterations](https://img.shields.io/badge/iterations-260%2B-orange)](#路线图)
...
| 分布式多 Agent 共享内存 — NUMA/RDMA 类比（iter 261+） | 🔜 计划中 |
